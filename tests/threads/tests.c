...
static const struct test tests[] = 
  {
    ...
    */
    ...
    {"rwsema4", test_rwsema4},
    {"rwsema5", test_rwsema5},
    {"rwsema6", test_rwsema6},
    {"seqlock1", test_seqlock1},
    {"seqlock2", test_seqlock2},
    {"seqlock3", test_seqlock3},
    {"seqlock4", test_seqlock4},
    {"seqlock5", test_seqlock5},
  };
