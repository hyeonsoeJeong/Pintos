...
/* List of processes in THREAD_READY state, that is, processes
   that are to run but not actually running. */
...
thread_unblock (struct thread *t) 
{
  ...
  // disable the interrupt to adjust ready list
...
// Wake up function
// Check the wake_time ; if timer_tick() is greater than wake_time, awake the thread

void wakeup_thread() {
  // sleep list를 스캔하며 wake_time을 체크하고 지났으면 ready_list로 넣음
